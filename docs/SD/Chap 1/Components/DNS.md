...
## [](https://kps.hashnode.dev/system-design-the-complete-course?ref=dailydev#heading-how-dns-works "Permalink")How DNS works
...
## [](https://kps.hashnode.dev/system-design-the-complete-course?ref=dailydev#heading-server-types "Permalink")Server types

Now, let's look at the four key groups of servers that make up the DNS infrastructure.

### [](https://kps.hashnode.dev/system-design-the-complete-course?ref=dailydev#heading-dns-resolver "Permalink")DNS Resolver
...
### [](https://kps.hashnode.dev/system-design-the-complete-course?ref=dailydev#heading-dns-root-server "Permalink")DNS root server
...
### [](https://kps.hashnode.dev/system-design-the-complete-course?ref=dailydev#heading-tld-nameserver "Permalink")TLD nameserver
...
### [](https://kps.hashnode.dev/system-design-the-complete-course?ref=dailydev#heading-authoritative-dns-server "Permalink")Authoritative DNS server
...
## [](https://kps.hashnode.dev/system-design-the-complete-course?ref=dailydev#heading-query-types "Permalink")Query Types

There are three types of queries in a DNS system:

### [](https://kps.hashnode.dev/system-design-the-complete-course?ref=dailydev#heading-recursive "Permalink")Recursive
...
### [](https://kps.hashnode.dev/system-design-the-complete-course?ref=dailydev#heading-iterative "Permalink")Iterative
...
### [](https://kps.hashnode.dev/system-design-the-complete-course?ref=dailydev#heading-non-recursive "Permalink")Non-recursive
...
## [](https://kps.hashnode.dev/system-design-the-complete-course?ref=dailydev#heading-records-types "Permalink")Records Types
...
## [](https://kps.hashnode.dev/system-design-the-complete-course?ref=dailydev#heading-subdomains "Permalink")Subdomains
...
## [](https://kps.hashnode.dev/system-design-the-complete-course?ref=dailydev#heading-dns-zones "Permalink")DNS Zones
...
## [](https://kps.hashnode.dev/system-design-the-complete-course?ref=dailydev#heading-dns-caching "Permalink")DNS Caching
...
## [](https://kps.hashnode.dev/system-design-the-complete-course?ref=dailydev#heading-reverse-dns "Permalink")Reverse DNS
